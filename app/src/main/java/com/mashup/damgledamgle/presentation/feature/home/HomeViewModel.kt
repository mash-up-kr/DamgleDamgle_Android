...
class HomeViewModel : ViewModel() {
    ...
    fun getMakerList(): ArrayList<MakerInfo> {
        ...
        list.add(MakerInfo(R.drawable.ic_heart_small,true, true,37.5455113, 127.0657011,0))
        list.add(MakerInfo(R.drawable.ic_angry_small,false, false,37.5448118, 127.0649041,0))
    ...
    fun getCalendarLastDay(): String {
        ...
        result = if( diff <= 1) getCalDiffTime(calendar) else "D-$diff"
